import { HttpRequest, HttpHandler, HttpEvent, HttpInterceptor, HttpErrorResponse, HttpSentEvent } from "@angular/common/http";
			...
			.pipe(
				catchError((error: HttpErrorResponse) => {
					if (error.error instanceof ErrorEvent) {
						...
						return auth.solicitarNuevoAccessToken(refreshToken)
							.pipe(
								retry(3),
								mergeMap(
									(respuesta: any) => {
